...
public class GradeController implements Observer {
    ...
    private final Image IMAGE_HOMEWORK = new Image(getClass().getResource("/Resources/homeworkPictogram.png").toString(), 64, 64, false, false);

    private final Image IMAGE_STUDENT = new Image(getClass().getResource("/Resources/studentPictogram.png").toString(), 64, 64, false, false);

    private final Image IMAGE_STUDENT_NOTSELECTED = new Image(getClass().getResource("/Resources/studentPictogramNotSelected.png").toString(), 100, 100, false, true);

    private final Image IMAGE_STUDENT_SELECTED = new Image(getClass().getResource("/Resources/studentPictogramSelected.png").toString(), 100, 100, false, true);

    private final Image IMAGE_STUDENT_HOVERED = new Image(getClass().getResource("/Resources/studentPictogramHover.png").toString(), 64, 64, false, false);

    private final Image IMAGE_GRADE = new Image(getClass().getResource("/Resources/gradePictogram.png").toString(), 64, 64, false, false);

    private final Image IMAGE_GRADE_HOVERED = new Image(getClass().getResource("/Resources/gradePictogramHover.png").toString(), 64, 64, false, false);

    private final Image IMAGE_HOMEWORK_NOTSELECTED = new Image(getClass().getResource("/Resources/homeworkPictogramNotSelected.png").toString(), 100, 100, false, false);

    private final Image IMAGE_HOMEWORK_SELECTED = new Image(getClass().getResource("/Resources/homeworkPictogramSelected.png").toString(), 100, 100, false, false);

    private final Image IMAGE_GRADE_NOTSELECTED = new Image(getClass().getResource("/Resources/gradePictogramNotSelected.png").toString(), 100, 100, false, false);

    private final Image IMAGE_GRADE_SELECTED = new Image(getClass().getResource("/Resources/gradePictogramSelected.png").toString(), 100, 100, false, false);

    private final Image IMAGE_HOMEWORK_HOVERED = new Image(getClass().getResource("/Resources/homeworkPictogramHover.png").toString(), 64, 64, false, false);

    private final Image IMAGE_CANCEL_BUTTON = new Image(getClass().getResource("/Resources/cancelStudent.png").toString(), 20, 28, false, false);

    private final Image IMAGE_CANCEL_BUTTON_HOVER = new Image(getClass().getResource("/Resources/cancelStudentHover.png").toString(), 20, 28, false, false);

    private final Image IMAGE_TRASH = new Image(getClass().getResource("/Resources/trashPictogram.png").toString(), 64, 64, false, false);

    private final Image IMAGE_TRASH_HOVERED = new Image(getClass().getResource("/Resources/trashPictogramHover.png").toString(), 64, 64, false, false);

...
public class StudentController implements Observer {
    ...
    private final Image IMAGE_STUDENT = new Image(getClass().getResource("/Resources/studentPictogram.png").toString(), 64, 64, false, true);
    ...
    private final Image IMAGE_TRASH_HOVERD = new Image(getClass().getResource("/Resources/trashPictogramHover.png").toString(), 64, 64, false, false);
